...
static int eventfs_set_attr(struct user_namespace *mnt_userns,
			    struct dentry *dentry,
			    struct iattr *iattr)
{
...
static int eventfs_get_attr(struct user_namespace *mnt_userns,
...
static int eventfs_permission(struct user_namespace *mnt_userns,
